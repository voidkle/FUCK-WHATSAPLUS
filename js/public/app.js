!(function (e, a, t) {
  ...
  if (
    (t(e).on("load", function () {
      var e = false;
      n.hasClass("menu-collapsed") && (e = true),
        t("html").data("textdirection"),
        setTimeout(function () {
          s.removeClass("loading").addClass("loaded");
        }, 1200),
        t.app.menu.init(e);
      false === t.app.nav.initialized && t.app.nav.init({ speed: 300 }),
        Unison.on("change", function (e) {
          t.app.menu.change();
        }),
        t('[data-toggle="tooltip"]').tooltip({ container: "body" }),
        t(".navbar-hide-on-scroll").length > 0 &&
          (t(".navbar-hide-on-scroll.fixed-top").headroom({
            offset: 205,
            tolerance: 5,
            classes: {
              initial: "headroom",
        ...
        t('a[data-action="expand"]').on("click", function (e) {
          e.preventDefault(),
            ...
            t(this).closest(".card").toggleClass("card-fullscreen");
        }),
        t(".scrollable-container").each(function () {
          new PerfectScrollbar(t(this)[0], { wheelPropagation: false });
        }),
        t('a[data-action="reload"]').on("click", function () {
          var e = t(this).closest(".card").find(".card-content");
          if (n.hasClass("dark-layout")) var a = "#10163a";
          else a = "#fff";
          e.block({
            message:
        ...
        t('.card .heading-elements a[data-action="collapse"]').on(
          ...
          function () {
            var e,
              a = t(this).closest(".card");
            parseInt(a[0].style.height, 10) > 0
              ? ((e = a.css("height")),
      ...
      "horizontal-menu" != r &&
        ...
        t(".heading-elements-toggle").on("click", function () {
      ...
      if (
        ...
        var m = h.width(),
          u = t(".app-content").position().left - m;
      ...
      t(".custom-file input").change(function (e) {
        ...
        t(".char-textarea").on("keyup", function (e) {
          !(function (e, a) {
            var s = parseInt(t(e).data("length")),
              n = t(".counter-value"),
              r = t(".char-textarea");
            (function (e) {
              return (
              ...
              (e.value.length < s - 1 && (e.value = e.value.substring(0, s)));
            t(".char-count").html(e.value.length),
              e.value.length > s
                ? (n.css("background-color", i),
                  r.css("color", i),
                  r.addClass("max-limit"))
                : (n.css("background-color", o),
                  r.css("color", l),
                  r.removeClass("max-limit"));
          })(this, e),
      ...
      var p = a.getElementsByClassName("main-menu-content");
      p.length > 0 &&
        p[0].addEventListener("ps-scroll-y", function () {
    ...
    t(a).on("click", ".sidenav-overlay", function (e) {
      return t.app.menu.hide(), false;
    }),
    "undefined" != typeof Hammer)
  ) {
    var r = a.querySelector(".drag-target");
    if (t(r).length > 0)
      new Hammer(r).on("panright", function (e) {
        if (n.hasClass("vertical-overlay-menu"))
          return t.app.menu.open(), false;
      });
    setTimeout(function () {
      var e,
        s = a.querySelector(".main-menu");
      t(s).length > 0 &&
        ((e = new Hammer(s))
          .get("pan")
    ...
    if (t(c).length > 0)
      new Hammer(c).on("panleft", function (e) {
        if (n.hasClass("vertical-overlay-menu"))
          return t.app.menu.hide(), false;
      });
  }
  t(a).on("click", ".menu-toggle, .modern-nav-toggle", function (a) {
      ...
      t("#collapse-sidebar-switch").length > 0 &&
        setTimeout(function () {
          n.hasClass("menu-expanded") || n.hasClass("menu-open")
            ? t("#collapse-sidebar-switch").prop("checked", false)
            : t("#collapse-sidebar-switch").prop("checked", true);
        }, 50),
      t(
    ...
    "undefined" != typeof screenfull &&
      screenfull.isEnabled &&
      t(a).on(screenfull.raw.fullscreenchange, function () {
        screenfull.isFullscreen
          ? (t(".nav-link-expand")
              .find("i")
              .toggleClass("icon-minimize icon-maximize"),
            t("html").addClass("full-screen"))
          : (t(".nav-link-expand")
              .find("i")
              .toggleClass("icon-maximize icon-minimize"),
            t("html").removeClass("full-screen"));
      }),
    t(a).ready(function () {
      t(".step-icon").each(function () {
        ...
        e.siblings("span.step").length > 0 &&
          ...
          t(this).appendTo(t(this).siblings("span.step")));
      });
    }),
    t(e).resize(function () {
    ...
    t(".dropdown-language .dropdown-item").on("click", function () {
      ...
      var a = e.text(),
        s = e.find(".flag-icon").attr("class");
      t("#dropdown-flag .selected-language").text(a),
  ...
  var d = t(".search-input input").data("search"),
    h = t(".bookmark-wrapper"),
    m = t(".bookmark-wrapper .bookmark-star"),
    u = t(".bookmark-wrapper .bookmark-input"),
    p = t(".nav-link-search"),
    f = t(".search-input"),
    v = t(".search-input input"),
    g = t(".search-input .search-list"),
    C = t(".app-content"),
    k = t(".bookmark-input .search-list");
  if (
    (m.on("click", function (e) {
      e.stopPropagation(),
        ...
        u.find("input").blur(),
        u.find("input").focus(),
        h.find(".search-list").addClass("show");
    ...
    t(".search-input-close i").on("click", function () {
      ...
      e.hasClass("open") &&
        ...
        v.blur(),
        g.removeClass("show"),
        C.removeClass("show-overlay"));
    }),
    t(".search-list-main").length)
  )
    var b = new PerfectScrollbar(".search-list-main", {
      wheelPropagation: false,
    });
  if (t(".search-list-bookmark").length)
    new PerfectScrollbar(".search-list-bookmark", { wheelPropagation: false });
  t(".search-list-main").mouseenter(function () {
    ...
    v.on("keyup", function (e) {
      if (
        ...
        27 == e.keyCode &&
          ...
          f.removeClass("open"),
          f.hasClass("show") &&
            (t(this).removeClass("show"), f.removeClass("show")));
        var a = t(this).val().toLowerCase(),
          s = "",
          n = false;
        if (
          (t("ul.search-list li").remove(),
          t(this).parent().hasClass("bookmark-input") && (n = true),
          "" != a)
        ) {
          C.addClass("show-overlay"),
            u.focus()
              ? k.addClass("show")
              : (g.addClass("show"), k.removeClass("show")),
            false === n && (g.addClass("show"), k.removeClass("show"));
          var i = "",
            o = "",
            l = "",
            r = "",
            ...
            m = "",
            p = 0;
          t.getJSON("../../../app-assets/data/" + d + ".json", function (e) {
            for (var d = 0; d < e.listItems.length; d++) {
              if (true === n) {
                s = "";
                for (
                  var u = t("ul.nav.navbar-nav.bookmark-icons li"), f = 0;
                  f < u.length;
                  f++
                ) {
                  if (
                    e.listItems[d].name ===
                    u[f].firstChild.dataset.originalTitle
                  ) {
                    s = " warning";
                    break;
                  }
              ...
              0 == e.listItems[d].name.toLowerCase().indexOf(a) &&
                p < 5 &&
                ((i +=
                  '<li class="auto-suggestion d-flex align-items-center justify-content-between cursor-pointer ' +
                  (0 === p ? "current_item" : "") +
            ...
            for (d = 0; d < e.listItems.length; d++) {
              if (true === n) {
                s = "";
                for (
                  u = t("ul.nav.navbar-nav.bookmark-icons li"), f = 0;
                  f < u.length;
                  f++
                )
                  s =
              ...
              0 != e.listItems[d].name.toLowerCase().indexOf(a) &&
                e.listItems[d].name.toLowerCase().indexOf(a) > -1 &&
                p < 5 &&
                ((o +=
                  '<li class="auto-suggestion d-flex align-items-center justify-content-between cursor-pointer ' +
                  (0 === p ? "current_item" : "") +
            ...
            (m = t(".main-search-list-defaultlist").html()),
              "" == i &&
                "" == o &&
                (o = t(".main-search-list-defaultlist-other-list").html()),
              (l = c.concat(i, o, m)),
              t("ul.search-list").html(l),
              (r = i.concat(o)),
              t("ul.search-list-bookmark").html(r);
          });
        } else if (true === n) {
          for (
            var b = t("ul.nav.navbar-nav.bookmark-iconss li"), w = "", y = 0;
            y < b.length;
            y++
          )
            0 === y ? "current_item" : "",
              (w +=
                ...
                b[y].firstChild.href +
                '><div class="d-flex justify-content-start align-items-center"><span class="mr-75 ' +
                b[y].firstChild.firstChild.className +
                '"  data-icon="' +
                b[y].firstChild.firstChild.className +
                '"></span><span>' +
                b[y].firstChild.dataset.originalTitle +
                '</span></div><span class="float-right bookmark-icon feather icon-star warning"></span></a></li>');
          t("ul.search-list").append(w);
        } else
          C.hasClass("show-overlay") && C.removeClass("show-overlay"),
    ...
    t("html").on("click", function (e) {
      t(e.target).hasClass("bookmark-icon") ||
        (k.hasClass("show") && k.removeClass("show"),
        u.hasClass("show") && u.removeClass("show"));
    }),
    t(a).on("click", ".bookmark-input input", function (e) {
      u.addClass("show"), k.addClass("show");
    }),
    t(a).on(
      "click",
      ...
      function (e) {
        if ((e.stopPropagation(), t(this).hasClass("warning"))) {
          ...
          for (
            var a = t("ul.nav.navbar-nav.bookmark-icons li"), s = 0;
            s < a.length;
            s++
          )
            a[s].firstChild.dataset.originalTitle ==
              t(this).parent()[0].innerText && a[s].remove();
          e.preventDefault();
        } else {
          ...
          (n =
            ...
            t(this).parent()[0].href +
            '" data-toggle="tooltip" data-placement="top" title="" data-original-title="' +
            t(this).parent()[0].innerText +
            '"><i class="ficon ' +
            t(this).parent()[0].firstChild.firstChild.dataset.icon +
            '"></i></a></li>'),
    ...
    t(e).on("keydown", function (a) {
      var s,
        n,
        i = t(".search-list li.current_item");
      if (
        (40 === a.keyCode
          ? ((s = i.next()),
          ...
          : 38 === a.keyCode &&
            ((n = i.prev()),
            i.removeClass("current_item"),
            (i = n.addClass("current_item"))),
        13 === a.keyCode && t(".search-list li.current_item").length > 0)
      ) {
