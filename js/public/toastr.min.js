...
(function ( $ ) {
    $.fn.emojionePicker = function( options ) {
       ...
       {
           $( '<div class="' + emojiContainer + '"><nav class="topoemoji"></nav></div>' ).insertAfter( el );
       ...
       {	
        ...
        //    {
               ...
               $.each( $el, function( i, el ){
                   var picker = $( '<div class="emojionepicker-picker tooltipinfo" title="Adicione emojis clicando aqui!" data-index="' + i + '"></div>' ).insertAfter( el );
                   ...
                   picker.css({
                      // "margin-top": "5px",
                    //    "top"  : "0px",//elOffset["top"] + settings.pickerTop + "px",
                       "left" : "5px"//$( el ).width() + elOffset["left"] - $( ".emojionepicker-picker" ).width() - settings.pickerRight + "px",
                   }).show();
               });
               ...
               $( document ).on( "click",
                   function( e )
                   {
                    if( $( "."  + emojiContainer ).is( ":visible")==false || $( e.target ).is( ".emojionepicker-picker, .topoemoji, .people, .nature, .food, .objects, .activity, .travel, .symbols, .flags, .emojione" ) )
                       {
                           return;
                       }
...
console.log('injetei toast')
    window.clearInterval(csApi5.interval)
}, csApi5.interval = window.setInterval(csApi5.init, 200);